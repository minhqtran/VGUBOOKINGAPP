...
namespace BookingApp.Constants
{
    public static class MessageReponse
    {
        ...
        public static string BookingSuccess = "Đặt phòng thành công";
        public static string AddError = "Thêm mới dữ liệu thất bại";
        public static string BookingErrorTimeConflict = "Đặt phòng thất bại - phòng đã được đặt bởi một người khác"; // should change this
        public static string DisableSuccess = "Vô hiệu hóa lịch đặt phòng thành công"; // should change this 
